  ...
  return (
    <div className='w-full flex flex-col '>
        <div className='w-full flex flex-col items-center justify-center'>
            ...
            <label className='w-full text-center text-5xl sm:text-[1.2rem] font-semibold font-urbanist'>I’m <span className='text-butonOrange typing-demo inline-block -mb-2'>Jannat Iqbal Shaikh , </span><br/>Full-Stack AI Developer</label>
            
        </div>
        <div className='w-full flex'>
            <div className='w-1/4 sm:w-1/5 sm:h-auto h-[70vh] flex items-center justify-center'>
                <a href='https://drive.google.com/file/d/1mgYFfyEOUlVcHYxoqnDuqv1a1H-TuwSQ/view?usp=sharing'  target="_blank" rel="noopener noreferrer" className='w-1/2 sm:w-[100px] sm:-mt-20 sm:-mr-14 sm:leading-none sm:text-[10px] ml-2 rounded-full bg-butonOrange p-3 sm:p-2 glowing-button text-white text-center cursor-pointer font-semibold text-2xl whitespace-nowrap'>View Resume</a>
            </div>
