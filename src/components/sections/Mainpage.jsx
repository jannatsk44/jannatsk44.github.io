  ...
  return (
    <div className='w-full flex flex-col '>
        <div className='w-full flex flex-col items-center justify-center'>
            ...
            <label className='w-full text-center text-5xl sm:text-[1.4rem] font-semibold font-urbanist'>I’m <span className='text-butonOrange typing-demo inline-block -mb-2'>Jannat Iqbal Shaikh, </span><br/>Full-Stack AI Developer</label>
