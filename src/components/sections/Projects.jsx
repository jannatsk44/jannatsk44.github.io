...
function Projects() {
  ...
  return (
    <div id='project' className='w-full flex flex-col sm:pb-10 sm:h-auto h-dvh'>
        ...
        <div>
            <ProjectCard title='AI Coding Training Asssitant  (React JS and DRF)' content='Built a web-based AI Training Assistant with ReactJS, Django DRF, and GPT to support programming trainees. It tracks user activity, provides coding help, and offers categorized questions. Admins can monitor progress and manage content through a dedicated panel.' link='https://github.com/jannatsk44/ai-chatbot'/>
          </div> 
        <div>
