...
function Skills() {
  return (
    <div id='skills' className='w-full flex flex-col sm:h-auto sm:pb-10 h-[90vh] rounded-[50px] bg-[#9ca3af]'>
        <label className='w-full opacity-100 z-10 text-5xl font-lufga font-semibold my-8 pr-16 sm:pr-5  sm:text-4xl text-right text-white'>My <span className='text-butonOrange'>Skills</span></label>
